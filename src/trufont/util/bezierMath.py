...
_interval = namedtuple('SturmInterval', (
    'min', 'max', 'sign_min', 'sign_max', 'id', 'exp_roots'))
        ...
        if nroots == 1:
            ...
            if mid - i.min <= eps:
                ...
                intervals.append(_interval(
                    i.min, mid, i.sign_min, sign_mid, id_, nroots))
                intervals.append(_interval(
                    mid, i.max, sign_mid, i.sign_max, id_, nroots))
                id_ += 1
